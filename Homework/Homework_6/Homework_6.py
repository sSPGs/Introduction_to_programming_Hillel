...
# for ind_list, value_list in enumerate(my_list):
my_list.sort()
print(my_list)
...
'''
#######################################################################
# my_list = ["baasasdasfaw", "skasknfmncxnb.a\e", "asfasfcxxczzzzz1`1112", "sasfadasf", "eet2344", "sdvxczzasfa", "asa","a1", "s1", "b1", "b2", "basd21", "s22a211sv!", "a_a", "as1", "_a", "aaa2222"]
...
'''
#######################################################################
# my_list_1 = [121, 'fjkjk', 3321, '300dsfgsd']
# my_list_2 = [1421, 'fFFFAAsd', 21, '3a0dd']
